...
./configure \
	...
	--extra-ldflags="-L../x264 -L../openssl -Wl,-z,relro -Wl,-z,now -pie" \
    --extra-cflags="-I$PLATFORM/usr/include -I../x264 -I../openssl/include -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -fno-strict-overflow -fstack-protector-all" \
    --target-os=linux \
    --arch=arm \
	--enable-gpl \
	--enable-libx264 \
